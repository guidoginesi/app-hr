...
export function AdminProfileDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div className="flex h-9 w-9 items-center justify-center rounded-full bg-foreground text-sm font-semibold text-white ring-2 ring-ring">
          {initials}
        </div>
      ...
      {/* Dropdown menu */}
      {isOpen && (
        <div className="absolute right-0 top-full z-50 mt-2 w-72 rounded-xl border border-[var(--border)] bg-white py-2 shadow-lg">
          {/* User info header */}
