    ...
    <div className="flex min-h-screen bg-muted text-foreground">
      ...
      <aside className="flex w-64 flex-shrink-0 flex-col border-r border-[var(--border)] bg-white shadow-sm">
        ...
        <nav className="flex-1 space-y-0.5 px-3 py-4">
          <Link
            href="/admin/messages"
            className="flex w-full items-center gap-2 rounded-lg px-3 py-2.5 text-sm font-medium text-secondary-foreground hover:bg-secondary hover:text-black"
          >
      ...
      <div className="flex min-h-screen min-w-0 flex-1 flex-col">
        <header className="flex h-16 items-center justify-between border-b border-[var(--border)] bg-white px-8 shadow-sm">
          <div>
            <h1 className="text-lg font-semibold tracking-tight text-foreground">Detalle del mensaje</h1>
            <p className="mt-0.5 text-xs font-normal text-muted-foreground">Métricas y lista de destinatarios</p>
          </div>
