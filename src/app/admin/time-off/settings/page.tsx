          ...
          <>
            ...
            <div className="rounded-xl border border-[var(--border)] bg-white shadow-sm">
              <div className="border-b border-[var(--border)] px-6 py-4">
                <h2 className="text-base font-semibold text-foreground">Tipos de Licencia</h2>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                          ...
                          <input
                            ...
                            className="w-16 rounded border border-[var(--border)] px-2 py-1 text-sm focus:border-brand focus:outline-none focus:ring-1 focus:ring-ring"
                          />
                          <span className="text-xs text-muted-foreground">días</span>
                        </div>
                        <Button
                          variant={type.is_active ? 'outline' : 'primary'}
                          size="sm"
                          onClick={() => handleToggleType(type)}
                          disabled={savingType === type.id}
                          loading={savingType === type.id}
                        >
            ...
            <div className="rounded-xl border border-[var(--border)] bg-white shadow-sm">
              <div className="border-b border-[var(--border)] px-6 py-4">
                <h2 className="text-base font-semibold text-foreground">Licencia por Estudio</h2>
                <p className="mt-1 text-sm text-muted-foreground">
                        ...
                        studyingEmployees.map((employee) => (
                          ...
                          >
                            ...
                            <Button
                              ...
                              loading={savingEmployee === employee.id}
                            >
                              Quitar
                            </Button>
                          </div>
            ...
            <div className="rounded-xl border border-[var(--border)] bg-white shadow-sm">
              <div className="border-b border-[var(--border)] px-6 py-4">
                <h2 className="text-base font-semibold text-foreground">Plantillas de Email</h2>
                <p className="mt-1 text-sm text-muted-foreground">
            ...
            <div className="rounded-xl border border-[var(--border)] bg-muted p-6">
              <h3 className="text-sm font-semibold text-foreground">Información sobre licencias</h3>
