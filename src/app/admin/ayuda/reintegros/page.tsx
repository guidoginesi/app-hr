  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        <ManualStep
          n={1}
          title="Quién puede pedir reintegros"
          image="/manual/reintegros-admin/02-habilitados.png"
          imageAlt="Pestaña Habilitados con la lista de personas, el filtro por área y un tilde por fila."
        >
        ...
        <ManualStep
          n={2}
          title="Los motivos son configurables"
          image="/manual/reintegros-admin/03-motivos.png"
          imageAlt="Pestaña Motivos con los seis motivos cargados, el campo para agregar uno nuevo y el tilde 'Se ofrece'."
        >
          ...
          <p>Un motivo <b>no se borra, se desactiva</b> con el tilde <b>Se ofrece</b>: deja de aparecer en el formulario pero los reintegros que ya lo usaron siguen mostrándolo. Debajo de cada nombre te dice en cuántos se usó.</p>
        ...
        <ManualStep
          n={4}
          title="La cola de People"
          image="/manual/reintegros-admin/01-cola.png"
          imageAlt="Pestaña Cola con los cuatro contadores —esperando al líder, a validar, a pagar y pagado— y el filtro por estado."
        >
          <p>Arriba tenés cuatro contadores que resumen dónde está la plata: <b>esperando al líder</b>, <b>a validar</b>, <b>a pagar</b> y <b>pagado</b>. Los dos primeros cuentan solicitudes; los dos últimos suman importes.</p>
          <p>El selector de la derecha filtra la lista. Por defecto viene en <b>Abiertos</b>, que es lo que requiere acción; podés pasar a los demás estados para ver el histórico.</p>
        ...
        <div className="rounded-xl border border-[var(--border)] bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Los pasos 5 a 9 muestran &quot;captura pendiente&quot;: esas pantallas sólo existen cuando hay un reintegro
            circulando, y todavía no hubo ninguno. Se agregan con el primero real.
          </p>
        </div>
      </div>
    </AyudaLayout>
