    ...
    <PortalShell employee={auth.employee} isLeader={auth.isLeader} active="ayuda">
      <div className="space-y-6">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-white shadow-sm p-6">
          ...
          <div className="mt-8 space-y-10">
            <ManualStep n={1} title="Dónde hacerla" imageAlt="Menú del portal con 'Consultas' resaltado en Recursos y el botón 'Nueva consulta'.">
            ...
            <ManualStep n={2} title="Escribirla" imageAlt="Formulario con Categoría, Asunto y el cuadro de la consulta.">
            ...
            <ManualStep n={3} title="Seguir el estado" imageAlt="Lista de consultas con los estados Nueva, En curso, Esperando tu respuesta, Resuelta y Cerrada.">
            ...
            <ManualStep n={4} title="La conversación" imageAlt="Detalle de una consulta con el ida y vuelta entre el colaborador y People.">
