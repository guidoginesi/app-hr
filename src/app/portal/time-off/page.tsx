    ...
    <PortalShell employee={employee} isLeader={isLeader} active="time-off">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {/* Vacaciones */}
          <div className="group relative rounded-xl border border-[var(--border)] bg-white p-5 shadow-sm cursor-help">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1">
                  <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Vacaciones</p>
            ...
            {/* Tooltip */}
            <div className="pointer-events-none absolute left-0 top-full z-50 mt-2 w-80 rounded-lg border border-[var(--border)] bg-white p-4 opacity-0 shadow-lg transition-opacity duration-200 group-hover:pointer-events-auto group-hover:opacity-100">
              <h4 className="font-semibold text-foreground mb-2">Política de Vacaciones</h4>
              <div className="space-y-2 text-xs text-muted-foreground">
                ...
                <div className="mt-2 pt-2 border-t border-[var(--border)]">
                  <p className="font-medium text-secondary-foreground mb-1">Días correspondientes por antigüedad:</p>
                ...
                <p className="mt-2 pt-2 border-t border-[var(--border)]">Se habilitan en <strong>Octubre</strong> de cada año y tenés tiempo hasta <strong>Abril</strong> del año siguiente para gozarlas.</p>
          ...
          <div className="group relative rounded-xl border border-[var(--border)] bg-white p-5 shadow-sm cursor-help">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1">
                  <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Días Pow</p>
                  <svg className="h-3.5 w-3.5 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
            ...
            {/* Tooltip */}
            <div className="pointer-events-none absolute left-0 top-full z-50 mt-2 w-72 rounded-lg border border-[var(--border)] bg-white p-4 opacity-0 shadow-lg transition-opacity duration-200 group-hover:pointer-events-auto group-hover:opacity-100">
              <h4 className="font-semibold text-foreground mb-2">Días Pow</h4>
              <div className="space-y-2 text-xs text-muted-foreground">
          ...
          {employee.is_studying && (
            <div className="rounded-xl border border-[var(--border)] bg-white p-5 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Estudio</p>
                  <p className="mt-0.5 text-2xl font-bold text-foreground">
          ...
          <div className="group relative rounded-xl border border-[var(--border)] bg-white p-5 shadow-sm cursor-help">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1">
                  <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Trabajo Remoto</p>
                  <svg className="h-3.5 w-3.5 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
            ...
            {/* Tooltip */}
            <div className="pointer-events-none absolute right-0 top-full z-50 mt-2 w-96 rounded-lg border border-[var(--border)] bg-white p-4 opacity-0 shadow-lg transition-opacity duration-200 group-hover:pointer-events-auto group-hover:opacity-100">
              <h4 className="font-semibold text-foreground mb-2">Trabajo Remoto</h4>
              <div className="space-y-2 text-xs text-muted-foreground">
                ...
                <div className="mt-2 pt-2 border-t border-[var(--border)]">
                  <p className="font-medium text-secondary-foreground mb-1">Requisitos para viajes:</p>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className="rounded-xl border border-[var(--border)] bg-muted p-4">
            <h3 className="font-medium text-foreground">Sobre las vacaciones</h3>
          ...
          <div className="rounded-xl border border-[var(--border)] bg-muted p-4">
            <h3 className="font-medium text-foreground">Días Pow</h3>
            <p className="mt-1 text-sm text-muted-foreground">
        ...
        <div className="rounded-xl border border-[var(--border)] bg-white shadow-sm">
          <div className="flex items-center justify-between border-b border-[var(--border)] px-6 py-4">
            ...
            <Link
              ...
              className="text-sm font-medium text-foreground hover:text-[var(--primary-hover)]"
            >
              Ver todas →
            </Link>
          </div>
