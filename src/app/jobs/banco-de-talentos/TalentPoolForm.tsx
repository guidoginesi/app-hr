    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Con esto alcanza para tenerte en el radar.</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Qué te interesa</CardTitle>
          <CardDescription>Nos sirve para avisarte cuando abramos algo de lo tuyo.</CardDescription>
        </CardHeader>
